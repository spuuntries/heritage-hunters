...
class Game:
    ...
    def main_menu(self):
        while True:
            ...
            PLAY_BUTTON = Button(image=pygame.image.load("../graphics/menu/Play Rect.png"), pos=(640, 250), 
            ...
            QUIT_BUTTON = Button(image=pygame.image.load("../graphics/menu/Quit Rect.png"), pos=(640, 550), 
